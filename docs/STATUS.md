...
Next:
- per-site blocking controls and filter-list updates;
...
Validation: targeted Rust/CXX tests, JS syntax checks and static workspace checks pass. A full Chromium build needs a larger builder than this VPS.
